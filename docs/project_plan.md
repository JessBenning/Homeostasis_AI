...
### 1.2 User Stories
- As a family member, I want to create a new member and assign a profile picture
...
- As a family member, I want to quickly see each member's task scores in a single view, ranked with 
...
- As a family member, I want to create and manage mulitple shared shopping lists
